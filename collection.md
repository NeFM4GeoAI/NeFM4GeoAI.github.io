...
<div class="sticky-outline">
  <ul>
    ...
    <li><a href="#surveys-books-tools-tutorials">Surveys, Books, Tools, Tutorials</a>
      <ul class="subsection">
    ...
    <li><a href="#methods-and-models">Methods and Models</a>
      <ul class="subsection">
        <li><a href="#hyperbolic-shallow-model">Hyperbolic Shallow Model</a></li>
        <li><a href="#hyperbolic-neural-network">Hyperbolic Neural Network</a></li>
        <li><a href="#hyperbolic-graph-neural-network">Hyperbolic Graph Neural Network</a></li>
        <li><a href="#hyperbolic-transformer">Hyperbolic Transformer</a></li>
        <li><a href="#mixed-curvature-learning">Mixed Curvature Learning</a></li>
        <li><a href="#semi-riemannian-learning">Semi-Riemannian Learning</a></li>
        <li><a href="#hyperbolic-generative-models">Hyperbolic Generative Models</a></li>
        <li><a href="#hyperbolic-operations">Hyperbolic Operations</a></li>
        <li><a href="#llm-and-hyperbolic-space">LLM && Hyperbolic Space</a></li>
        <li><a href="#analysis">Analysis</a></li>
        <li><a href="#numerical-problems">Numerical Problems</a></li>
        <li><a href="#explicitly-tree-embedding">Explicitly Tree Embedding</a></li>
      </ul>
    </li>
...
.sticky-outline .subsection a:hover {
  color: #B22222;
}
